...
Const.FEKOefefilename          = 'plate2_NearField2.efe';
...
[SolutionPO] = runPOsolver(Const, Solver_setup, zMatrices, yVectors, xVectors);
...
legend('SUN-EM', 'SUN-EM PO','FEKO (*.efe file)', 'FEKO (*.ffe file)');
...
Efield_scaling_factorPO = Efield_magnitudePO'./FEKO_Efield_magnitude;
plot(1:total_efield_samples,Efield_scaling_factor);
plot(1:total_efield_samples,Efield_scaling_factorPO);
