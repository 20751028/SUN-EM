function HfieldAtPointSpherical =  calculateHfieldAtPointRWG(Const, r, theta_degrees, phi_degrees, ...
    Solver_setup, Isol)
    ...
    for freq_index = 1:Solver_setup.frequencies.freq_num
        ...
        % transform the H-field vector, to one in Sperical Coordinates
