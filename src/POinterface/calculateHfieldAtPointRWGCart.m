...
for freq_index = 1:Solver_setup.frequencies.freq_num
    ...
    triangle_plus = Solver_setup.rwg_basis_functions_trianglePlus(nzind);
    triangle_minus = Solver_setup.rwg_basis_functions_triangleMinus(nzind);
    rMplus = Solver_setup.triangle_centre_point(triangle_plus,:);
    rMminus = Solver_setup.triangle_centre_point(triangle_minus,:);
